...
// 2 cách tạo mảng
// array literal
// const students1 = ["pho", "pho", "nam", "thanh", "trung"];
// array constructor
const students2 = new Array();
// Ví dụ một mảng
// Mảng phức tạp [0, false, undefined, null, "pho", ["pho", false, 1200, []] ]
// Mảng đơn giản [0, false, undefined, null, "pho"]
// index: chạy từ 0
// length: đếm từ 1
...
const students1 = ["pho", "pho", "nam", "thanh", "trung", "pho"];
// arrayName.method
...
console.log(students1.includes("pho")); // true
console.log(students1.includes("pho2")); // false
