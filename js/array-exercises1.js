// 1. Đảo ngược một chuỗi. Ví dụ: "My name is pho" -> "pho is name My";
...
console.log(reverseString("My name is pho"));
...
reverseWord("i love");
// 3. In hoa chữ cái đầu trong chuỗi ví dụ: "my name is pho" -> "My Name Is pho"
